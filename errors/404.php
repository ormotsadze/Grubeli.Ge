...
<head>
    ...
    <style>
        ...
        .error-code {
            ...
            font-size: 8rem;
            line-height: 1;
            background: linear-gradient(135deg, #0dcaf0 0%, #0d6efd 50%, #6610f2 100%);
...
<script>
    // ანიმირებული წვიმის წვეთების გენერაცია

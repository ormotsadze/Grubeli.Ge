...
<main class="container-xl py-4 flex-grow-1">
  ...
  <div class="row g-4">
    ...
    <div class="col-12 reveal-up delay-3">
      <div class="premium-glass p-4 p-md-5 card-accent-cyan interactive-card position-relative overflow-hidden">
        ...
        <div class="row align-items-center position-relative z-index-1">
          ...
          <div class="col-lg-4 text-center mt-4 mt-lg-0">
            <div class="qr-placeholder mx-auto d-flex align-items-center justify-content-center position-relative">
              <i class="fas fa-qrcode fa-5x" style="color:rgba(255,255,255,0.05);"></i>
              <span class="position-absolute small text-white-50">QR — Coming Soon</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Android App -->
    <div class="col-12 reveal-up delay-3">
      <div class="premium-glass p-4 p-md-5 card-accent-emerald position-relative overflow-hidden">
...
<style>
.pulse-dot{width:10px;height:10px;background:#20c997;border-radius:50%;display:inline-block;animation:pulse 2s infinite;}
@keyframes pulse{0%{box-shadow:0 0 0 0 rgba(32,201,151,0.7)}70%{box-shadow:0 0 0 10px rgba(32,201,151,0)}100%{box-shadow:0 0 0 0 rgba(32,201,151,0)}}
.interactive-card{display:flex;flex-direction:column;justify-content:center;}
...
.social-pill{padding:12px 20px;background:rgba(255,255,255,0.05);border-radius:50px;color:rgba(255,255,255,0.8);border:1px solid rgba(255,255,255,0.1);text-decoration:none;transition:0.3s ease;text-align:center;display:block;}
.social-pill:hover{background:rgba(13,202,240,0.2);color:#fff;border-color:#0dcaf0;transform:translateY(-2px);}
.qr-placeholder{width:150px;height:150px;border:2px dashed rgba(255,255,255,0.1);border-radius:20px;}
.btn-app{background:rgba(32,201,151,0.12);border:1px solid rgba(32,201,151,0.3);border-radius:14px;padding:12px 20px;color:#fff;text-decoration:none;transition:0.3s;}
.btn-app:hover{background:rgba(32,201,151,0.22);color:#fff;transform:translateY(-2px);}
.btn-app i{font-size:1.4rem;color:#20c997;}
</style>
